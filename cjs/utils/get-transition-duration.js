...
exports.getTransitionDuration = exports.getTransitionDurationFromTheme = exports.getMotionDurationValue = void 0;
var get_token_1 = require("./get-token");
var responsive_helpers_1 = require("./responsive-helpers");
var utils_1 = require("./style/utils");
var getMotionDurationValue = function (transitionDuration) {
...
exports.getMotionDurationValue = getMotionDurationValue;
var extractDurationFromPreset = function (tokensArray, theme) {
    return tokensArray.reduce(function (duration, currentToken) {
        var transitionPreset = (0, utils_1.unifyTransition)(theme, currentToken);
        ...
        if (appearActive || enterActive || exitActive) {
            var appearDuration = (appearActive &&
                ...
                (0, exports.getMotionDurationValue)(appearActive.transitionDuration)) ||
                0;
            var appearDelay = (appearActive &&
                appearActive.transitionDelay &&
                (0, exports.getMotionDurationValue)(appearActive.transitionDelay)) ||
                0;
            var enterDuration = (enterActive &&
                enterActive.transitionDuration &&
                (0, exports.getMotionDurationValue)(enterActive.transitionDuration)) ||
                0;
            var enterDelay = (enterActive &&
                enterActive.transitionDelay &&
                (0, exports.getMotionDurationValue)(enterActive.transitionDelay)) ||
                0;
            var exitDuration = (exitActive &&
                exitActive.transitionDuration &&
                (0, exports.getMotionDurationValue)(exitActive.transitionDuration)) ||
                0;
            var exitDelay = (exitActive &&
                exitActive.transitionDelay &&
                (0, exports.getMotionDurationValue)(exitActive.transitionDelay)) ||
                0;
            return {
        ...
        var baseDuration = (base &&
            ...
            (0, exports.getMotionDurationValue)(base.transitionDuration)) ||
            0;
        var baseDelay = (base &&
            base.transitionDelay &&
            (0, exports.getMotionDurationValue)(base.transitionDelay)) ||
            0;
        return {
...
var getTransitionDurationFromTheme = function (themeToken) { return function (props) {
    var tokensArray = typeof themeToken === 'string' ? [themeToken] : themeToken;
    return extractDurationFromPreset(tokensArray, props.theme);
}; };
exports.getTransitionDurationFromTheme = getTransitionDurationFromTheme;
...
var getTransitionDuration = function (defaultPath, overridePath) { return function (props) {
    var token = (0, get_token_1.getToken)(props, defaultPath, overridePath, 'transitionPreset');
    if (!token)
        return { enter: 0, exit: 0, appear: 0 };
    if ((0, responsive_helpers_1.isResponsive)(token, props.theme.breakpoints)) {
        return Object.entries(token).reduce(function (acc, _a) {
            var transitionPresetToken = _a[1];
            var tokensArray = (0, utils_1.isArrayLikeObject)(transitionPresetToken)
    ...
    var tokensArray = (0, utils_1.isArrayLikeObject)(token)
        ? Object.values(token)
        : [token];
    return extractDurationFromPreset(tokensArray, props.theme);
}; };
