...
exports.getSingleStylePreset = exports.getStylePreset = exports.getStylePresetFromTheme = exports.getPresetStyles = void 0;
...
var getPresetStyles = function (presetStyles, options) {
    ...
    var _e = filterStyles
        ...
        : (0, filter_object_1.rejectObject)(presetStyles, omitStyles), iconColor = _e.iconColor, placeholderColor = _e.placeholderColor, cssObject = tslib_1.__rest(_e, ["iconColor", "placeholderColor"]);
    if (iconColor) {
        return tslib_1.__assign(tslib_1.__assign({}, cssObject), getCssSvgFillObject(iconColor, isSvg));
    }
    if (placeholderColor) {
        return tslib_1.__assign(tslib_1.__assign({}, cssObject), { '::placeholder': {
...
var getPresetStates = function (stylePreset, options) {
    ...
    var _p = filterStates && filterStates.length
        ...
        : (0, filter_object_1.rejectObject)(stylePreset, omitStates), selected = _p.selected, loading = _p.loading, invalid = _p.invalid, valid = _p.valid, presetStates = tslib_1.__rest(_p, ["selected", "loading", "invalid", "valid"]);
    ...
    if (stateOverrides) {
        ...
        var pseudoOverridesObj = pseudoOverrides && typeof pseudoOverrides === 'object'
            ? pseudoOverrides
            : {};
        return tslib_1.__assign({ base: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, baseStyles), stateOverridesObj), pseudoOverridesObj) }, filteredPseudoPresets);
    }
    return presetStates;
};
var addSafariMediaTag = function (cssObject, safariOutlineOffset, safariOutlineStyle) {
    ...
    cssObject['@media not all and (min-resolution: 0.001dpcm)'] = {
        '@supports (-webkit-appearance: none) and (stroke-color: transparent)': tslib_1.__assign(tslib_1.__assign({}, outlineOffset), outlineStyle),
    };
};
var getStylePresetValueFromTheme = function (stylePreset, options) {
    return Object.entries(getPresetStates(stylePreset, options)).reduce(function (acc, _a) {
        ...
        if (presetState) {
            ...
            var _b = (0, exports.getPresetStyles)(presetState, options), safariOutlineOffset = _b.safariOutlineOffset, safariOutlineStyle = _b.safariOutlineStyle, styles = tslib_1.__rest(_b, ["safariOutlineOffset", "safariOutlineStyle"]);
...
exports.getSingleStylePreset = getSingleStylePreset;
