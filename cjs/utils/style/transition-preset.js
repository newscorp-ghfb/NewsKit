...
exports.getTransitionPreset = exports.getTransitionPresetFromTheme = void 0;
...
var getTransitionPresetValueFromTheme = function (transitionPreset, componentClassName) {
    return Object.entries(transitionPreset).reduce(function (acc, _a) {
        ...
        if (stateStyles && Object.keys(stateStyles).length) {
            ...
            if (stateKey === 'base') {
                return tslib_1.__assign(tslib_1.__assign({}, acc), stateStyles);
            }
...
function concatAndMergeInTransitionStringsForPseudoState(entry, mergedTransitionPreset) {
    ...
    var updatedStateStyles = tslib_1.__assign(tslib_1.__assign({}, stateStyles), combinedTransitionProperties);
...
var getMergedTransitionPresets = function (token, theme) {
    var mergedTransitionPresets = token
        .map(function (tkn) { return (0, utils_1.unifyTransition)(theme, tkn); })
...
var setDurationZero = function (transitionPreset) {
    ...
    Object.keys(transitionPreset).map(function (key) {
        ...
        presetWithoutDuration[key] = tslib_1.__assign({}, stateObj);
    ...
    return function (props) {
        ...
        if ((0, responsive_helpers_1.isResponsive)(token, props.theme.breakpoints)) {
            tokenAsSingleOrMultiply = Object.entries(token).reduce(function (acc, currVal) {
                ...
                acc[bp] = ((0, utils_1.isArrayLikeObject)(trValue)
            ...
            tokenAsSingleOrMultiply = (0, utils_1.isArrayLikeObject)(token)
                ? Object.values(token)
                : token;
        }
...
exports.getTransitionPreset = getDefaultedValue(exports.getTransitionPresetFromTheme, 'transitionPreset');
