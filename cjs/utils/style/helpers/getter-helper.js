 ...
 * Capsize cropping.
 */
var getFontMetrics = function (typographyPreset, themeFonts) {
...
var getFontFamilyObject = function (fontFamily, themeFonts) {
    ...
    var fontFamilyObject = array.find(function (fontEl) {
        return (0, guards_1.isFontConfigObject)(fontEl) &&
...
var isValidFontMetrics = function (fontMetrics, fontFamily) {
    if (fontMetrics && (0, guards_1.isFontMetricsObject)(fontMetrics))
        return true;
