...
exports.newskitDarkTheme = exports.newskitDarkThemeOverrides = void 0;
var creator_1 = require("./creator");
exports.newskitDarkThemeOverrides = {
    colors: {
        ...
        interactiveFocus020: '{{colors.blackTint090}}',
    },
    overlays: {
        ...
        overlayGradientBaseHorizontal: 'linear-gradient(-90deg, rgba(17,17,17,0.00) 0%, rgba(17,17,17,1.00) 100%)',
        overlayGradientBaseVertical: 'linear-gradient(0deg, rgba(17,17,17,0.00) 0%, rgba(17,17,17,1.00) 100%)',
        overlayGradientInverseHorizontal: 'linear-gradient(-90deg, rgba(198,198,198,0.00) 0%, rgba(198,198,198,1.00) 100%)',
        overlayGradientInverseVertical: 'linear-gradient(0deg, rgba(198,198,198,0.00) 0%, rgba(198,198,198,1.00) 100%)',
    },
    outline: {
        safariOutlineStyleDefault: 'solid',
    },
};
exports.newskitDarkTheme = (0, creator_1.createTheme)({
    name: 'newskit-dark',
    overrides: exports.newskitDarkThemeOverrides,
});
//# sourceMappingURL=newskit-dark.js.map