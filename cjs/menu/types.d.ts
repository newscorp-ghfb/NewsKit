...
export interface MenuItemProps extends Omit<BaseFlagProps<MenuItemOverrides>, 'loading'>, React.AnchorHTMLAttributes<HTMLAnchorElement>, EventData {
    children: Exclude<React.ReactNode, 'undefined'>;
    href: string;
    selected?: boolean;
...
export type MenuSubProps = Omit<MenuItemProps, 'title' | 'overrides' | 'href'> & {
