export declare const wsjOverrides: {
    typographyPresets: {
        editorialDisplay010: {
            fontFamily: string;
            fontWeight: string;
...
export declare const wsjTheme: import("../../..").UncompiledTheme;
//# sourceMappingURL=wsj-theme.d.ts.map