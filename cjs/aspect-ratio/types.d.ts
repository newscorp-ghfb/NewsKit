import { MaxHeightProperty, MaxWidthProperty, PaddingTopProperty, HeightProperty, WidthProperty } from 'csstype';
 ...
 */
export interface AspectRatioProps extends GetAspectRatioProp, Omit<ContainerProp, 'paddingTop'> {
}
