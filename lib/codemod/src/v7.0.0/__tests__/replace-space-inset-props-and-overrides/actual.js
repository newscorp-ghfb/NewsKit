import {Flag, Button, Modal, Menu, MenuGroup, MenuItem, MenuSub, StructuredListItem, StructuredListCell} from "newskit";
...
const Component = () => (
  <>
    ...
    <Block spaceInset={{xs: "space020", md: "space060"}} stylePreset="inkContrast">Block</Block>
    <StructuredListItem
      overrides={{
