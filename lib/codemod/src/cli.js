...
const TRANSFORMS = {
  ...
  'remove-redundant-marker-ul': 'Unordered List has now a default marker, removes the prop passing the same icon now set as default.',
  'update-list-item-marker-ul-value': 'Unordered List has now a default marker, the script passes "listItemMarker" with a value of "null" to UnorderedList components originally not passing any marker.',
};
