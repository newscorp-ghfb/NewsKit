...
const TRANSFORMS = {
  ...
  'emotion-icons': 'Update newskit icons to use @emotion-icons',
  'remove-redundant-marker-ul': 'Unordered List has now a default marker, if you are passing the same with a props the script would clean and remove it.',
  'update-list-item-marker-ul-value': 'Unordered List has now a default marker, in order to keep the behavior where it is not shown, this script will pass a null value.',
};
