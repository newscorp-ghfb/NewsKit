...
function tagReplacement(j, oldTags, newTags) {
  const createOpeningTags = oldTags.find(j.JSXOpeningElement, {
    name: {
      type: 'JSXIdentifier',
      name: 'Link',
    },
  ...
  const createClosingTags = oldTags.find(j.JSXClosingElement, {
    name: {
      type: 'JSXIdentifier',
      name: 'Link',
    },
