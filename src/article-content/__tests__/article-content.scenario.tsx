...
export const name = 'article-content';

export const component = () => [
  <StorybookHeading>Bold intro &amp; bold headings</StorybookHeading>,
  <ArticleContent $boldIntro $boldHeadings>
    <P>
      The first paragraph of text will be in bold, when the boldIntro prop is
      set to true. After that the text will continue in normal font-weight.
    </P>
  ...
  <StorybookHeading>No bold</StorybookHeading>,
  <ArticleContent>
    <P>
      The first paragraph in this ArticleContent block is not bold because the
