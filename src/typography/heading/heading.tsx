...
import {
  LogicalProps,
  logicalPropsWithTypographyCropSupport,
...
const ThemelessHeading1 = styled.h1<HeadingOverrides>`
  ...
  ${logicalPropsWithTypographyCropSupport('headlineH1')}
`;
...
const ThemelessHeading2 = styled.h2<HeadingOverrides>`
  ...
  ${logicalPropsWithTypographyCropSupport('headlineH2')}
`;
...
const ThemelessHeading3 = styled.h3<HeadingOverrides>`
  ...
  ${logicalPropsWithTypographyCropSupport('headlineH3')}
`;
...
const ThemelessHeading4 = styled.h4<HeadingOverrides>`
  ...
  ${logicalPropsWithTypographyCropSupport('headlineH4')}
`;
...
const ThemelessHeading5 = styled.h5<HeadingOverrides>`
  ...
  ${logicalPropsWithTypographyCropSupport('headlineH5')}
`;
...
const ThemelessHeading6 = styled.h6<HeadingOverrides>`
  ...
  ${logicalPropsWithTypographyCropSupport('headlineH6')}
`;
