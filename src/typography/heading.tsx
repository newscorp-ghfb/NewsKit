...
export const Heading1 = styled.h1<HeadingOverrides>`
  margin: 0;
  padding: 1px 0;
  ${getTypePreset('headlineH1', '', {withCrop: true})}
...
export const Heading2 = styled.h2<HeadingOverrides>`
  margin: 0;
  padding: 1px 0;
  ${getTypePreset('headlineH2', '', {withCrop: true})}
...
export const Heading3 = styled.h3<HeadingOverrides>`
  margin: 0;
  padding: 1px 0;
  ${getTypePreset('headlineH3', '', {withCrop: true})}
...
export const Heading4 = styled.h4<HeadingOverrides>`
  margin: 0;
  padding: 1px 0;
  ${getTypePreset('headlineH4', '', {withCrop: true})}
...
export const Heading5 = styled.h5<HeadingOverrides>`
  margin: 0;
  padding: 1px 0;
  ${getTypePreset('headlineH5', '', {withCrop: true})}
...
export const Heading6 = styled.h6<HeadingOverrides>`
  margin: 0;
  padding: 1px 0;
  ${getTypePreset('headlineH6', '', {withCrop: true})}
