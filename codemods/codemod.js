...
var jscodeshift = require('jscodeshift/src/Runner').run;
var path = require('path');
var glob = require('glob');
function expandFilePathsIfNeeded(filesBeforeExpansion) {
    var shouldExpandFiles = filesBeforeExpansion.some(function (file) {
        return file.includes('*');
    });
    return shouldExpandFiles
        ? filesBeforeExpansion.map(function (filePath) { return glob.sync(filePath); }).flat()
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, jscodeshift(transformPath, filesExpanded, options)];
                case 1:
                    res = _a.sent();
                    console.log(res);
                    return [2 /*return*/];
