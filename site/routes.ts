      ...
      },
      {
        ...
        subNav: [
          ...
          },
          {
            title: 'Font metrics',
            illustration: 'theme/component-defaults/hero',
            description: 'Calculate font metrics for your theme',
            page: true,
            id: '/theme/theming/font-metrics',
            nextId: '/theme/theming/using-a-theme',
            buttonLabel: 'Calculate font metrics for your theme',
          },
        ],
      },
    ],
