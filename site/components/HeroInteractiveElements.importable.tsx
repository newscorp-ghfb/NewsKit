...
} from './homepage/hero/styled';
import {HeroInteractiveElementsProps} from './homepage/hero/types';
import HeroGridLogo from './illustrations/landing-page/hero-grid-logo';
import {SelectionList, SelectionListOption} from '../../src/selection-list';
...
export const HeroInteractiveElements = ({
  themeMode,
  toggleTheme,
