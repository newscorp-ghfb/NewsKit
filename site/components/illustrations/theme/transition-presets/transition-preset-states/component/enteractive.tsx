...
export const enterActive: React.FC = () => {
  ...
  return (
    ...
    >
      <g clipPath={`url(#${clip0})`}>
        ...
        <Path d="M110 77H350V923H110V77Z" fill="illustrationPalette020" />
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M635.776 438.603C628.764 434.249 619.686 439.277 619.686 447.513V480.85H389.995C385.027 480.85 381 484.865 381 489.819C381 494.773 385.027 498.789 389.995 498.789H619.686V533.487C619.686 541.721 628.761 546.749 635.773 542.399L705.034 499.428C711.654 495.322 711.656 485.714 705.037 481.605L635.776 438.603Z"
          fill="illustrationInterface090"
        />
        <Path
          d="M110 205H277.5C284.956 205 291 211.044 291 218.5V218.5C291 225.956 284.956 232 277.5 232H110V205Z"
          fill="illustrationPalette030"
        />
        <Path
          d="M110 264H181.5C188.404 264 194 269.596 194 276.5V276.5C194 283.404 188.404 289 181.5 289H110V264Z"
          fill="illustrationPalette030"
        />
        <Path
          opacity="0.4"
          d="M110 375H284.5C288.09 375 291 377.91 291 381.5V381.5C291 385.09 288.09 388 284.5 388H110V375Z"
          fill="white"
        />
        <Path
          opacity="0.4"
          d="M110 409H282C286.971 409 291 413.029 291 418V418C291 422.971 286.971 427 282 427H110V409Z"
          fill="white"
        />
        <Path
          opacity="0.4"
          d="M110 335H283C287.418 335 291 338.582 291 343V343C291 347.418 287.418 351 283 351H110V335Z"
          fill="white"
        />
        <Path
          opacity="0.4"
          d="M110 447H143C147.418 447 151 450.582 151 455V455C151 459.418 147.418 463 143 463H110V447Z"
          fill="white"
        />
      </g>
      <defs>
