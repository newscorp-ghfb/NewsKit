...
With CSSObject
<CodeFromFile path="examples/utils/get-device-query-from-theme-css-object.tsx"/>

With SerializedStyles
<CodeFromFile path="examples/utils/get-device-query-from-theme-serialized-styles.tsx"/>
