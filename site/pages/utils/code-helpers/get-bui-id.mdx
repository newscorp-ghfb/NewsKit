...
Retrieve a uniquie ID that is automatically incremented in the format of: `bui-{id}`
...
Returns a string that is a unique and incremented ID in the format of: `bui-{id}`

## Example 1

<CodeFromFile path="examples/utils/get-bui-id-map.tsx" />

In this example the unique ID provided is used for the key attribute for React.

## Example 2

<CodeFromFile path="examples/utils/get-bui-id-for.tsx" />
