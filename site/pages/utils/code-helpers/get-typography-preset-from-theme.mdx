...
<Code>{'getTypographyPresetFromTheme(defaultToken, customProp)(props)'}</Code>
...
<CodeFromFile path="examples/utils/get-typography-preset-from-theme.tsx"/>
...
<Code>{'<Paragraph typographyPreset="subhead050" />'}</Code>
