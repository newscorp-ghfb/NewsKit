...
if (!process.browser && RUN) {
  ...
  (async () => {
    ...
    const imprtPaths = paths
      ...
      .filter(path => !ignoreList.includes(path));
    ...
    //   //svgComponents,
    // });
    // '../../components/illustrations/components/checkbox/hero'
    // '../../components/illustrations/about/release-notes-hero-illustration
    // '../../components/illustrations/about/introduction-hero-stepping-stones-illustration'
    // const Component = await import(short[8]);
