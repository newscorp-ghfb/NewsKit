...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="typePreset" type="string">
    If provided, this overrides the type preset applied to the Flag. Otherwise,
    flag010 or flag020 is used depending on the `size` prop.
  </Prop>
