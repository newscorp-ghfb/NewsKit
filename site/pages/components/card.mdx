...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="media" type="ImageProps | React.ComponentType">
    If this parameter is provided as <InlineCode>ImageProps</InlineCode> object (see <Link href="/components/image">Image documentation</Link>), it will render the media as an image.<br />
  ...
  <Prop name="overrides" type="object">
    ...
    the <Link href="/components/headline">Headline</Link> as shown on the examples below.
  </Prop>
</LegacyBlock>
