...
NewsKit provides 6 types of predefined style preset flags variants.
...
| tagPrimaryInverse       |  <div style={{backgroundColor: 'black'}}><Tag overrides={{stylePreset: 'tagPrimaryInverse'}}> Text </Tag></div>     | 
