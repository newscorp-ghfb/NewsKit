...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="spaceInset" type="string">
    ...
    <Prop name="typographyPreset" type="MQ<string>">
      ...
      utilityLabel010, utilityLabel020 or utilityLabel030 is used depending on the `size` prop.
    </Prop>
...
NewsKit provides 2 types of predefined style preset tags variants.

### Types

The inverse examples sit on a black background.

| StylePreset           |  Tag                                                                          | 
| -------------- | :------------------------------------------------------------------------------: |
| tagPrimary          |  <Tag overrides={{stylePreset: 'tagPrimary'}}> Text </Tag>     | 
| tagPrimaryInverse       |  <LegacyBlock display="inline-block" backgroundColor="black"><Tag overrides={{stylePreset: 'tagPrimaryInverse'}}> Text </Tag></LegacyBlock>     | 
