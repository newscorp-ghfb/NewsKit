...
All you need to do is pass a href property with valid url. <Link href="/components/action/button">Button links</Link> can be styled in the same way as a regular Button component.
