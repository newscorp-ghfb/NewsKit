...
<LegacyBlock $marginTop="sizing05">
  ...
  <Prop name="$trackStylePreset" type="string" default="interactive030">
    If provided, this overrides the style preset applied to the slider track.
  </Prop>
  <Prop name="$indicatorStylePreset" type="string" default="interactive010">
  ...
  <Prop name="$thumbStylePreset" type="string" default="interactive020">
    If provided, this overrides the style preset applied to the slider thumb.
  </Prop>
  <Prop name="$labelStylePreset" type="string" default="interactive010Inverse">
