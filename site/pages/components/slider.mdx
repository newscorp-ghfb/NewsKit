...
import {StatefulSlider, styled, Heading1, UnorderedList} from 'newskit';
...
<LegacyBlock marginTop="sizing050">
  ...
  <Prop name="labelPosition" type="string" default="inline">
    ...
    }} children={[`'inline' - places the slider between the min/max labels`,
      `'before' - places the min/max labels before the slider`,
      `'after' - places the labels after the slider element.`]}>
    </UnorderedList>
