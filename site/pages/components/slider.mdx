...
<LegacyBlock marginTop="sizing050">
  ...
  <Prop name="labelPosition" type="LabelPosition" default="LabelPosition.Inline">
    ...
    }} listItemMarker={Circle} children={[`LabelPosition.Inline - places the slider between the min/max labels`,
  ...
  <Prop name="thumbIcon" type="IconComponent">
  ...
  <Prop name="overrides" type="SliderOverrideProps">
    ...
    <Prop name="track" type="object">
      <Prop name="stylePreset" type="StylePresetKeys" default="sliderTrack">
        If provided, this overrides the style preset applied to the slider track.
      </Prop>
      <Prop name="size" type="SizingKeys" default="sizing030">
        If provided, this overrides the size of the slider track.
      </Prop>
    </Prop>
    <Prop name="indicator" type="object">
      <Prop name="stylePreset" type="StylePresetKeys" default="sliderIndicator">
    ...
    <Prop name="thumb" type="object">
      <Prop name="stylePreset" type="StylePresetKeys" default="sliderThumb">
        If provided, this overrides the style preset applied to the slider thumb.
      </Prop>
      <Prop name="size" type="SizingKeys" default="sizing060">
        If provided, this overrides the size of the slider thumb.
      </Prop>
    </Prop>
    <Prop name="thumbLabel" type="object">
      <Prop name="stylePreset" type="StylePresetKeys" default="sliderThumbLabel">
      ...
      <Prop name="typePreset" type="TypePresetKeys" default="label030">
        If provided, this overrides the type preset applied to the in-built slider thumb label.
      </Prop>
      <Prop name="space" type="SizingKeys" default="sizing060">
    ...
    <Prop name="labels" type="object">
      <Prop name="stylePreset" type="StylePresetKeys" default="sliderLabels">
      ...
      <Prop name="typePreset" type="TypePresetKeys" default="label020">
        If provided, this overrides the type preset applied to the in-built min/max labels.
      </Prop>
      <Prop name="space" type="SizingKeys" default="sizing030">
