...
A group of functions used to retrieve values from the <a href="/foundations/theming/component-defaults">component defaults or overrides objects</a>.
...
Used to retrieve value mapped to the <a href="/foundations/presets/space-presets/">spaceInline</a> key in the component defaults/overrides
...
Used to retrieve value mapped to the <a href="/foundations/presets/space-presets/">spaceStack</a> key in the component defaults/overrides
