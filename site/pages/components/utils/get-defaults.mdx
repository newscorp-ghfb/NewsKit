...
Used to retrieve value mapped to the <a href="/theme/spacing/">spaceInline</a> key in the component defaults/overrides
...
Used to retrieve value mapped to the <a href="/theme/spacing/">spaceStack</a> key in the component defaults/overrides
