...
You can read about their usage [here](https://www.newskit.co.uk/theming/using-a-theme) or on Emotion's official documentation site [Theming](https://emotion.sh/docs/theming#api).