...
`getShadowCssFromTheme`, `getSizingCssFromTheme`, `getSpacingCssFromTheme` share the same annotation, therefore we will generalize them as `the getter function`.
...
The visual representation of every component is formed by combining multiple tokens into presets and group of presets later stored into <a href="/theming/component-defaults/overview">component defaults object.</a>
...
For more information on what consists of style preset see doc [here](/foundations/presets/style-presets/).
