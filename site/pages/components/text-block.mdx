...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="as" type="'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'div' | 'span'" default="p">
    This is a string name with one of the following html elements: h1, h2, h3, h4, h5, h6 or div, that the textblock can be converted to.
    TextBlock defaults as a p element, but it can be converted to another heading element or div by `as="div"` prop.
  </Prop>
