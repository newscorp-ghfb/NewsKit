  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="heading" type="object">
      ...
      <Prop name="typographyPreset" type="MQ<TypographyPresetKeys>">
        If provided, this overrides the typography preset applied to the heading.
      </Prop>
    </Prop>
    <Prop name="kicker" type="object">
      <Prop name="stylePreset" type="MQ<StylePresetKeys>">
        If provided, this overrides the style preset applied to the kicker.
      </Prop>
      <Prop name="typographyPreset" type="MQ<TypographyPresetKeys>">
        If provided, this overrides the typography preset applied to the kicker.
      </Prop>
