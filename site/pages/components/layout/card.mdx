...
import {CardMediumWithoutInset} from '../../../demo-components/card/card-medium-without-inset';
import {CardSmallWithInset} from '../../../demo-components/card/card-small-with-inset';
...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="contentAndActionsContainer" type="object">
      <Prop name="stylePreset" type="MQ<string>" >
