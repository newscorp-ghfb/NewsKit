...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    You are still able to override the default <InlineCode>Headline</InlineCode> styles by passing the overides directly to the
    <Link href="/components/text-content/headline">Headline</Link> as shown on the examples below.
  </Prop>
</LegacyBlock>
