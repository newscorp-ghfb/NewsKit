...
import {AudioPlayer, UnorderedList, Block, Link} from 'newskit';
  ...
  <Prop name="overrides" type="object">
    <Prop name="seekBar" type="object">
      <Prop name="slider" type="SliderOverrideProps">
        ...
        <Link href="/components/selection-controls/slider">slider documentation page</Link>. If player is in live
    ...
    <Prop name="controls" type="ControlsOverrideProps">
      ...
      <Prop name="previousButton" type="ButtonOverrides">
        Overrides for previous track button. See all availble options in the <a href="/components/action/button"> button docs</a>.
      </Prop>
      <Prop name="replayButton" type="ButtonOverrides">
        Overrides for skip replay button. See all availble options in the <a href="/components/action/button"> button docs</a>.
      </Prop>
      <Prop name="playPauseButton" type="ButtonOverrides">
        Overrides for play / pause button. See all availble options in the <a href="/components/action/button"> button docs</a>.
      </Prop>
      <Prop name="forwardButton" type="ButtonOverrides">
        Overrides for skip forward button. See all availble options in the <a href="/components/action/button"> button docs</a>.
      </Prop>
      <Prop name="nextButton" type="ButtonOverrides">
        Overrides for next track button. See all availble options in the <a href="/components/action/button"> button docs</a>.
      </Prop>
      <Prop name="popoutButton" type="ButtonOverrides">
        Overrides for popout button. See all availble options in the <a href="/components/action/button"> button docs</a>.
      </Prop>
    </Prop>
    <Prop name="volumeControl" type="VolumeControlOverrideProps">
      ...
      <a href="/components/media/volume-control">volume control documentation page</a>.
    </Prop>
