  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="externalIcon" type="object">
      <Prop name="size" type="string">
        ...
        E.g: "iconSize030". For more tokens please refer to the <Link href="/components/icons">/components/icons page</Link>.
        <br />
        <br />
      ...
      For more information about how to apply overrides to a component please refer to the <Link href="/theming/component-defaults/overview">Override component defaults</Link> page.
...
All you need to do is pass a href property with valid url. <Link href="/components/button">Button links</Link> can be styled in the same way as a regular Button component.
...
<LegacyBlock display="inline-block" backgroundColor="black">
 <Link href="/" overrides={{stylePreset: 'linkInlineInverse'}}>Inline link inverse</Link>
</LegacyBlock>
<Code>
  {`
...
<Link href="http://google.com/" overrides={{stylePreset: 'linkExternal'}}>External link with external icon</Link>
<Code>
  {`
<Link
...
<LegacyBlock display="inline-block" backgroundColor="black">
  <Link href="http://google.com/" overrides={{stylePreset: 'linkExternalInverse'}}>External link with external icon</Link>
</LegacyBlock>
<Code>
  {`
<Link
