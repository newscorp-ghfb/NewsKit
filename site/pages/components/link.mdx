...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="externalIcon" type="object">
      ...
      For more information about how to apply overrides to a component please refer to the <Link href="/theming/component-defaults">Override component defaults</Link> page.
