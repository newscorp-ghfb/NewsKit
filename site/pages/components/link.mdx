...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="externalIcon" type="object">
      ...
      For more information about how to apply overrides to a component please refer to the <a href="/foundations/theming/component-defaults">Override component defaults</a> page.
...
For more information on overriding component defaults, see the docs [here](/foundations/theming/component-defaults/).
...
<LegacyBlock display="inline-block" backgroundColor="black">
 <a href="/" overrides={{stylePreset: 'linkInlineInverse'}}>Inline link inverse</a>
</LegacyBlock>
<Code>
  {`
...
<a href="http://google.com/" overrides={{stylePreset: 'linkExternal'}}>External link with external icon</a>
<Code>
  {`
<Link
...
<LegacyBlock display="inline-block" backgroundColor="black">
  <a href="http://google.com/" overrides={{stylePreset: 'linkExternalInverse'}}>External link with external icon</a>
</LegacyBlock>
<Code>
  {`
<Link
