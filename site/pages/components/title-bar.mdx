...
<LegacyBlock marginTop="sizing050">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="stylePreset" type="string" default="titleBar">
      If provided, this overrides the style preset applied to the TitleBar.
    </Prop>
    <Prop name="paddingPreset" type="object" default="{
    ...
    <Prop name="heading" type="object">
      <Prop name="typePreset" type="string" default="{
        xs: 'heading040',
        md: 'heading050',
        lg: 'heading070'
      }">
        If provided, this overrides the type preset applied to the TitleBar heading.
      </Prop>
      <Prop name="stylePreset" type="string" default='headlineContent'>
        If provided, this overrides the type preset applied to the TitleBar heading.
      </Prop>
    </Prop>
       Refer to the defaults below for the object structure:
...
We suggest you to use the style preset `titleBarButton` and `titleBarLink` respectively for a Button and a Link action.
