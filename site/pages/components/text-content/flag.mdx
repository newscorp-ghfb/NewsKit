...
| StylePreset             |  Flag                                                                  | 
| ----------------------- | :---------------------------------------------------------------------:|
| flagSolidInverse        |  <Flag overrides={{stylePreset: 'flagSolidInverse'}}> Text </Flag>     | 
| flagSolidLiveInverse    |  <Flag overrides={{stylePreset: 'flagSolidLiveInverse'}}> Text </Flag> | 
| flagMinimalInverse      |  <Flag overrides={{stylePreset: 'flagMinimalInverse'}}> Text </Flag>   |      
