...
| flagSolidInverse        |  <div style={{backgroundColor: 'black'}}><Flag overrides={{stylePreset: 'flagSolidInverse'}}> Text </Flag> </div>    | 
| flagSolidLiveInverse        |  <div style={{backgroundColor: 'black'}}><Flag overrides={{stylePreset: 'flagSolidLiveInverse'}}> Text </Flag></div>     | 
| flagMinimalInverse        |   <div style={{backgroundColor: 'black'}}><Flag overrides={{stylePreset: 'flagMinimalInverse'}}> Text </Flag></div>     | 
