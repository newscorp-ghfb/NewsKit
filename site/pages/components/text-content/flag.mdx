...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="typographyPreset" type="MQ<string>">
      ...
      utilityLabel010 or utilityLabel030 is used depending on the `size` prop.
    </Prop>
...
| StylePreset           |  Flag                                                                          | 
| -------------- | :------------------------------------------------------------------------------: |
| flagSolidInverse        |  <LegacyBlock display="inline-block" backgroundColor="black"><Flag overrides={{stylePreset: 'flagSolidInverse'}}> Text </Flag> </LegacyBlock>    | 
| flagSolidLiveInverse        |  <LegacyBlock display="inline-block" backgroundColor="black"><Flag overrides={{stylePreset: 'flagSolidLiveInverse'}}> Text </Flag></LegacyBlock>     | 
| flagMinimalInverse        |   <LegacyBlock display="inline-block" backgroundColor="black"><Flag overrides={{stylePreset: 'flagMinimalInverse'}}> Text </Flag></LegacyBlock>     |      |
