...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="width" type="number | string | undefined"></Prop>
    The intrinsic width of the image in pixels.
  <Prop name="height" type="number | string | undefined"></Prop>
    The intrinsic width of the image in pixels.
  ...
  <Prop name="sources" type="ImageSource[]">
    ...
    . ImageSource extends{' '}
    <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLSourceElement">
      Image Source element
    </a>
    , the only difference is that you can use breakpoint key{' '}
  ...
  <Prop name="loading" type="'lazy' | 'eager'">
    Specifies how the image will load: eager will load as soon as possible, Lazy
    will wait till the browser estimates it will be needed. See{' '}
  ...
  <Prop name="fit" type="ObjectPositionProperty<string>">
    Specifies how the image will be resized to fit the container. See{' '}
  ...
  <Prop name="position" type="ObjectFitProperty">
    Specifies the position of the image within it's box. See{' '}
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="width" type="MQ<string>" default="100%">
      ...
      a consistent manner. It is not recommended to have both height and width
    ...
    <Prop name="height" type="MQ<string>" default="auto">
      ...
      consistent manner. It is not recommended both height and width values to
