...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="divider" type="DividerProps['overrides']">
      ...
      optional <Link href="/components/divider">dividers</Link> between
      the tab buttons.
    </Prop>
    ...
    <Prop name="scroll" type="ScrollProps['overrides']">
      If provided, this overrides the styles applied to the <Link href="/components/scroll">Scroll</Link>.
...
<LegacyBlock marginTop="sizing040">
  <Prop name="children" type="React.ReactNode" required>
    ...
    panel, you can wrap them in <a href="/components/text-block">
      TextBlock
