...
import {ExampleBlock, BlockWithBorder, StyledBlockForDivider, InlineBlock, InlineDividerContainer} from '../../components/examples/divider/styled';

import {Divider, BorderKeys, ColorKeys, SizingKeys, Block, Stack, StackChild, AlignSelfValues, Circle} from 'newskit';
...
<LegacyBlock marginTop="sizing050">
  ...
  <Prop name="overrides" type="object">
    ...
    <Prop name="stylePreset" type="StylePresetKey" default="dividerHorizontal">
...
<CodeFromFile language="jsx" path="examples/divider/divider-horizontal-in-block.tsx" />
...
<CodeFromFile language="jsx" path="examples/divider/divider-vertical-in-block.tsx" />
...
<CodeFromFile language="jsx" path="examples/divider/divider-vertical-in-stack.tsx" />
