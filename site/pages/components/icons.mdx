...
NewsKit provides utility functions to create themably icons from SVG file or <Link href="https://emotion-icons.dev/" target="_blank">emotion-icons</Link>.
...
>
  From version newskit@6 we don't export emotion icons.
  <br /> Please read bellow how to to import and use emotions icons in your project.
</InlineMessage>

## Using Emotion icons

From version `newskit@6.0.0` we do not export <Link href="https://www.npmjs.com/package/@emotion-icons/emotion-icon" target="_blank">emotion-icons</Link>.

In order to contunie using these icons you will need to import them directly from `emotion-icons` package and convert them to NewsKit icons using `toNewsKitIcon` utility function.
...
The following example shows how to convert an emotion icon to NewsKit icon:
