...
<InlineMessage title="Warning" overrides={{stylPreset: 'inlineMessageNegative'}}>
  From version newskit@6 we don't export emotion icons anymore.<br /> Please read bellow how to to import and use emotions icons in your project.
</InlineMessage>
