...
From version `newskit@6.0.0` we do not export <Link href="https://www.npmjs.com/package/@emotion-icons/emotion-icon" target="_blank">emotion-icons</Link>. In order to contunie using these icons you will need to import them directly from `emotion-icons` package and covert them to NewsKit icons using `toNewsKitIcon` utility function.
