...
<LegacyBlock marginTop="sizing050">
  ...
  <Prop
    name="renderTrack"
    type="(params: { props, children, dragged, disabled }) => React.ReactNode"
  >
    ...
    contain the thumb and should be rendered inside your track, and dragged
    and disabled booleans; these might affect how you wish to style your track.
  </Prop>
  <Prop
    name="renderThumb"
    type="((params: { props, value, index, dragged }) => React.ReactNode"
  >
    ...
    to this thumb (this is useful if rendering more than one value), dragged;
  ...
  knobs={[
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: 'Component',
          value: withProps(IconFilledCircle, {overrides:{size: 'sizing040'}}, 'MyLabelIcon'),
        },
      ],
    },
    {
