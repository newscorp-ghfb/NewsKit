...
<LegacyBlock marginTop="sizing040">
  <Prop name="sourcePointConfigUnified" required>
    ...
    The 'usnat' object should contain 'includeUspApi' parameter set to 'true'. This enables the gpp string (part of the MSPS signal). Instructions and additional MSPS settings can be found in <a href="https://docs.sourcepoint.com/hc/en-us/articles/21455316499731#h_01HC0NYD93FV6MBBH6Y1NPCRMX" target="_blank">this Sourcepoint guide</a>. 
    ...
    <Prop name="usnat" type="object">
      ...
      <Prop name="includeUspApi" type="boolean">
        Including this flag as 'true' enables support for the existing (Legacy) USP string.&nbsp;
