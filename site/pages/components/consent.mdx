...
Note the use of the AMP `Head` component. The `Consent` component must be used as a child of `Head`. See <a href='/guides/getting-started-amp'>Getting Started with AMP</a> for more information.
