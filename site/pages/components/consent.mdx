...
<LegacyBlock $marginTop='sizing040'>
  ...
  <Prop name='mmsDomain' type='string' default="https://message{accountId}.sp-prod.net">
    Can be changed to a CNAMED subdomain in order to deliver 1st party cookies on Safari web browser (due to Safari’s ITP). Changing the mmsDomain is optional! More information about setting up an mmsDomain below.
  </Prop>
