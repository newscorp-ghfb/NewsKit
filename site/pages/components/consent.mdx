...
<LegacyBlock marginTop="sizing040">
  <Prop name='sourcePointConfigTCFV2' required>
    ...
    optional Parameters: <b>propertyHref,privacyManagerId, siteId, targetingParams, mmsDomain, waitForConsent</b>. See <a href="https://documentation.sourcepoint.com/web-implementation/sourcepoint-set-up-and-configuration-v2">Sourcepoint documentation</a> for full description of options.
  </Prop>
  ...
  >
    ...
    on Safari web browser (due to Safari’s ITP). Changing the mmsDomain is
...
<LegacyBlock marginTop="sizing040">
  ...
  <Prop name="policy" type="object">
    ...
    For the structure of the policy, please visit <a href="https://amp.dev/documentation/components/amp-consent/#customize-consent-blocking-behaviors">the documentation</a>.
  </Prop>
