...
<LegacyBlock marginTop="sizing040">
  <Prop name="sourcePointConfigUnified" required>
    ...
    To enable default MSPA configuration ccpa object should contain 'includeGppApi' parameter set to 'true'. Instructions and additional MSPS settings can be found in [this Sourcepoint guide](https://docs.sourcepoint.com/hc/en-us/articles/18007731422099-Enable-GPP-Multi-State-Privacy-String-MSPS-with-U-S-Privacy-CCPA-solution). 
    ...
    <Prop name="ccpa" type="object">
      ...
      <Prop name="includeGppApi" type="boolean | MSPATransactions">
        ...
        MSPS settings could be customized by passing configuration object to the includeGppApi as [shown here](https://docs.sourcepoint.com/hc/en-us/articles/18007731422099-Enable-GPP-Multi-State-Privacy-String-MSPS-with-U-S-Privacy-CCPA-solution).
      </Prop>
    </Prop>
  </Prop>
