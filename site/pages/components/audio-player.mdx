...
<Block $marginTop="sizing05">
  ...
  <Prop name="$volumePresets" type="Object<SliderStylePresets>">
    ...
    <ul>
      <li>$indicatorStylePreset</li>
      <li>$thumbStylePreset</li>
      <li>$trackStylePreset</li>
      <li>$labelStylePreset</li>
    </ul>
  </Prop>
  ...
  <Prop name="$controlPresets" type="Object<ControlPresets>">
    ...
    <ul>
      ...
      <li>
        replay: preset for skip replay button, defaults to interactive010Inverse
      </li>
      <li>play: preset for play / pause button, defaults to interactive010</li>
      <li>
        forward: preset for skip forward button, defaults to
        interactive010Inverse
      </li>
      <li>
        next: preset for next track button, defaults to interactive010Inverse
      </li>
    </ul>
  </Prop>
</Block>
