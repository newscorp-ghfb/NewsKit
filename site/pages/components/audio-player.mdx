  ...
  <Prop name="popoutHref" type="string">
    ...
    <Prop name="seekBar" type="object">
      ...
      <Prop name="buffering" type="object">
        <Prop name="stylePreset" type="string" default="volumeControlButtons">
    ...
    <Prop name="controls" type="ControlsOverrideProps">
      ...
      <Prop name="space" type="string" default="SizingKeys">
        Setting the space between the control buttons.
      </Prop>
      <Prop name="previousButton" type="object" >
        <Prop name="stylePreset" type="StylePresetKeys" >
