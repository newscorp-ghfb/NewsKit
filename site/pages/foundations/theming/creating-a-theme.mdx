...
You can switch between these two themes on this documentation site by clicking the button in the top right. Details on how to use a theme in your project can be found [here](/foundations/theming/using-a-theme/).
...
Therefore, the above example is equivalent to the following function theme value:

<CodeFromFile path="examples/theming/extends-keyword-equivalent.ts" />
