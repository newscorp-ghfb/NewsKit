...
NewsKit offers you the ability to theme all components. To get started with theming, see: [creating a theme](/foundations/theming/creating-a-theme).
...
- The [ThemeProvider](/foundations/theming/using-a-theme/) allows the user to provide a theme that is passed to all NewsKit components nested inside it.
