...
In the example above, the `typePreset` will be overridden with `buttonMedium` and `stylePreset` will be replaced with `buttonOutlinedPrimary`, leaving the other presets untouched. Following this example, the other fields can overridden in a similar way. <br/>
