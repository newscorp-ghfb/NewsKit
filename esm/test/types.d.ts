...
export type RenderFn<R> = <T extends {}>(Component: React.ComponentType<T>, props?: T, theme?: ThemeProviderProps['theme'], options?: Omit<RenderOptions, 'wrapper'>) => R;
export type RenderFnFactory<R> = (defaultTheme: ThemeProviderProps['theme']) => R;
