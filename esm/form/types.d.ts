...
export interface FormProps extends React.HtmlHTMLAttributes<HTMLFormElement>, LogicalProps {
...
export type FieldsHadErrorObject = Record<string, {
    hadError: boolean;
}>;
export type FormInputState = 'disabled' | 'valid' | 'invalid' | undefined;
export type CommonInputProps = Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size'> & {
