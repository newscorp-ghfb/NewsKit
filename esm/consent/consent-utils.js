...
export var getV2Scripts = function (config) {
    ...
    return [
        ...
        },
        {
            content: "window._sp_ = ".concat(JSON.stringify({
                config: __assign(__assign({}, config), { baseEndpoint: baseEndpoint }),
            }, replacer)),
        },
        {
...
export var getUnifiedScripts = function (config) {
    var baseEndpoint = (config.baseEndpoint && config.baseEndpoint.replace(/\/$/, '')) ||
        'https://cdn.privacy-mgmt.com';
...
export var getNonTCFScripts = function (config) {
    var baseEndpoint = (config.baseEndpoint && config.baseEndpoint.replace(/\/$/, '')) ||
        'https://cdn.privacy-mgmt.com';
...
export var isV2Props = function (props) {
    return Boolean(props.sourcePointConfigTCFV2);
};
export var isUnifiedProps = function (props) {
    return Boolean(props.sourcePointConfigUnified);
};
export var isNonTCFV1Props = function (props) {
