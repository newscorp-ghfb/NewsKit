...
export default {
    menuItemVertical: {
        ...
        'focus-visible': __assign(__assign({}, defaultFocusVisible), { outlineOffset: '-{{outlines.outlineOffsetDefault}}' }),
    },
    menuItemHorizontal: {
        base: {
            backgroundColor: '{{colors.transparent}}',
    ...
    menuItemHorizontalInverse: {
        ...
        'focus-visible': __assign(__assign({}, inverseFocusVisible), { outlineOffset: '-{{outlines.outlineOffsetDefault}}' }),
    },
    menuSubItemVertical: {
        base: {
            backgroundColor: '{{colors.transparent}}',
