...
import { ObjectFitProperty, HeightProperty, WidthProperty, MaxHeightProperty, MaxWidthProperty, ObjectPositionProperty } from 'csstype';
...
export interface ImageCommonProps extends React.ImgHTMLAttributes<HTMLImageElement> {
    isLoading?: boolean;
...
export interface StyledImageProps extends React.ImgHTMLAttributes<HTMLImageElement>, ImageAlignmentProps, ImageCommonProps {
    loading?: LoadingType;
    overrides?: {
...
export interface ImageProps extends React.ImgHTMLAttributes<HTMLImageElement>, ImageAlignmentProps {
...
export interface ImageSource extends Omit<React.SourceHTMLAttributes<HTMLSourceElement>, 'media'> {
