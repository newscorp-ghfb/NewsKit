...
var getAutoResolvingPath = function (obj, breakpoints, path, autoKey) {
    ...
    var value = get(obj, modifiedPath);
    if (typeof value === 'string' || isResponsive(value, breakpoints)) {
        return value;
    }
    return autoKey ? get(obj, "".concat(modifiedPath, ".").concat(autoKey)) : value;
};
/**
 ...
 *
 */
export var getToken = function (props, defaultPath, overridePath, propName) {
