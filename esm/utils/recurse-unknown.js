...
var parseAndGet = function (theme, value, errorLogger, stack) {
    ...
    if (tokens.length) {
        ...
        return tokens.reduce(function (result, tokenPath) {
            var tokenValue = get(theme, tokenPath);
            if (typeof tokenValue === 'undefined') {
                ...
                tokenValue = parseAndGet(theme, tokenValue, errorLogger, __spreadArray([
                    tokenPath
                ], stack, true));
            }
...
export var recurseUnknown = function (theme, value, errorLogger) {
    ...
    if (typeof value === 'object' && !Array.isArray(value)) {
        ...
        return Object.entries(value).reduce(function (acc, _a) {
            ...
            if (key === '__extends' || key === '__deepExtends') {
                ...
                var mergeFn = key === '__deepExtends' ? deepMerge : Object.assign.bind(Object);
                return mergeFn.apply(void 0, __spreadArray([{}, acc], extendsObjects, false));
            }
