...
import { Boundary, FloatingContext, Placement, useInteractions } from '@floating-ui/react-dom-interactions';
...
export interface FloatingElementProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title' | 'defaultValue' | 'content'> {
    children: React.ReactElement<any> & {
        ref?: React.Ref<HTMLElement>;
    };
    trigger?: TriggerType | TriggerType[];
    content: React.ReactNode | ((referenceProps: ReferenceProps, context: FloatingContext<HTMLElement>) => React.ReactNode);
    open?: boolean;
    placement?: Placement;
    overrides?: {
        zIndex?: number;
...
export interface BaseFloatingElementProps extends FloatingElementProps {
    role?: AriaRole;
    useInteractions: (context: FloatingContext<HTMLElement>) => ReturnType<typeof useInteractions>;
