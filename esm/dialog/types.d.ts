...
export interface BaseDialogProps extends Omit<BaseDialogViewProps, 'className' | 'path' | 'handleCloseButtonClick' | 'open'>, Omit<BaseDialogFunctionProps, 'children' | 'renderOverlay'>, React.AriaAttributes {
}
